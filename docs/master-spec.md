...
|---|---|---|
| Should Distributed tables be initialized by Manager or left to application users? | TBD | Phase 02 / Phase 04 |
| How should write routing be exposed for multi-shard clusters? | TBD | Phase 02 |
| How should DDL idempotency be guaranteed? | TBD | Phase 02 / Phase 04 |
